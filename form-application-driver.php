...
if ($responsekeys->success) {
  if (
    ...
    if (isset($_POST['accident_chemical1'])) $Message .= "Chemical Spills: ".$_POST['accident_chemical1']."\n";
    if ($_POST['accident_dates1'] || $_POST['accident_nature1'] || $_POST['accident_fatalities1'] || $_POST['accident_injuries1'] || isset($_POST['accident_chemical1'])) $Message .= "\n";
    ...
    if (isset($_POST['accident_chemical2'])) $Message .= "Chemical Spills: ".$_POST['accident_chemical2']."\n";
    if ($_POST['accident_dates2'] || $_POST['accident_nature2'] || $_POST['accident_fatalities2'] || $_POST['accident_injuries2'] || isset($_POST['accident_chemical2'])) $Message .= "\n";
    ...
    if (isset($_POST['accident_chemical3'])) $Message .= "Chemical Spills: ".$_POST['accident_chemical3']."\n";
    if ($_POST['accident_dates3'] || $_POST['accident_nature3'] || $_POST['accident_fatalities3'] || $_POST['accident_injuries3'] || isset($_POST['accident_chemical3'])) $Message .= "\n";
    ...
    if (isset($_POST['denied'])) $Message .= "Have you ever been denied a license, permit or privilege to operate a motor vehicle? ".$_POST['denied']."\n";
    if ($_POST['denied_explain']) $Message .= "If yes, explain: ".$_POST['denied_explain']."\n";
    if (empty($_POST['denied']) || $_POST['denied_explain']) $Message .= "\n";

    if (isset($_POST['revoked'])) $Message .= "Has any license, permit or privilege ever been suspended or revoked? ".$_POST['revoked']."\n";
    if ($_POST['revoked_explain']) $Message .= "If yes, explain: ".$_POST['revoked_explain']."\n";
    if (isset($_POST['revoked']) || $_POST['revoked_explain']) $Message .= "\n";
